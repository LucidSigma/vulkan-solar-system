...
{
	m_size = size;
	m_windowHandle = SDL_CreateWindow(title.data(), SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, m_size.x, m_size.y, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE | SDL_WINDOW_ALLOW_HIGHDPI | SDL_WINDOW_VULKAN);
...
void Window::SetIcon(const std::string_view& iconFilepath) const
{
	...
	if (iconSurface == nullptr)
	{
		...
		throw std::runtime_error("Failed to create window icon surface.");
	}
