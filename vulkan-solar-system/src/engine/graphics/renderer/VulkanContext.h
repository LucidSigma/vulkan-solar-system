...
public:
	...
	inline VkSampleCountFlagBits GetMSAASampleCount() const noexcept { return m_msaaSampleCount; }
	inline float GetMaxAnisotropy() const noexcept { return m_maxAnisotropy; }
